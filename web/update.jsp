...
<html lang="en">
    ...
    <body>
        ...
        <form id="f1" name="f1" method="post" action="#"  enctype="multipart/form-data" >
            ...
            <%
             String sql="select * from circular where id='"+id+"'";
...
rs.next();
            ...
            <table width="39%" height="438" border="0" align="center">
                ...
                <tr>&nbsp;</tr>
                <tr>
                    <td height="42" colspan="2"  align="center" ><div class="style5"><h3>Update Circular</h3>
                        </div></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td height="54">circular Name</td>
                    <td><label><input name="name" type="text" id="name" value="<%out.print(rs.getString("name"));%>"/></label></td>
                </tr>
                <tr>
                    <td height="47">Year</td>
                    <td><input name="year" type="text" id="year" value="<%out.print(rs.getString("year1"));%>"/></td>
                </tr>
                <tr>
                    <td height="41">Department</td>
                    <td><input name="depart" type="text" id="depart"  value="<%out.print(rs.getString("depart"));%>"/></td>
                </tr>
                <tr>
                    <td height="45">Semester</td>
                    <td><input type="text" name="sem" id="sem" value="<%out.print(rs.getString("sem"));%>"></td>
                </tr>
                <tr>
                    <td height="51">Description</td>
                    <td><input name="desc" type="text" id="desc" value="<%out.print(rs.getString("descr"));%>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="55">&nbsp;</td>
                    <td><input name="btn" type="submit" id="btn" value="Update Circular" />

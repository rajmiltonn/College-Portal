...
<form id="f1" name="f1" method="post" action="#"  enctype="multipart/form-data" >
            <table width="39%" height="438" border="0" align="center">
                ...
                <tr>&nbsp;</tr>
                <tr>
                    <td height="42" colspan="2"  align="center" ><div class="style5"><h3>Add Documents</h3>
                        </div></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td height="54"> Name</td>
                ...
                <tr>
                    <td height="55">&nbsp;</td>
                    <td><input name="btn" type="submit" id="btn" value="Add Document" />
                ...
                try {
                    ...
                    while (itr.hasNext()) {
                        ...
                        if (item.isFormField()) {
                            ...
                            ResultSet ns = stmt.executeQuery("select max(id) as maxid from documents");
                            ns.next();
                            int id1 = ns.getInt("maxid");
                            int id2 = id1 + 1;

                            String qq = "insert into documents values('" + id2 + "','" + name + "','" + depart + "','" + sem + "','" + desc + "','" + year1 + "','" + fileName + "','" + rdate + "','0')";
                            int n = stmt.executeUpdate(qq);
                            if (n == 1) {
            %>
            <script language="javascript">
                alert("Documents Add Successfully...");
                window.location.href = "stud_home.jsp"
            </script>
